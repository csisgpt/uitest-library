...
import {
  ...
  xr,
  yO
} from "./chunk-DSZP7KIL.js";
import {
  require_core_events
} from "./chunk-M7PRWPDV.js";
import {
  z
} from "./chunk-7NYP6QH7.js";
import {
  require_react
} from "./chunk-IFOMHZVP.js";
import {
  require_preview_errors
} from "./chunk-HCZHP46Z.js";
import {
  require_preview_api
} from "./chunk-6D3FHYK3.js";
import {
  dedent
...
var require_memoizerific = __commonJS2({ "../../node_modules/memoizerific/memoizerific.js"(exports, module) {
  (function(f2) {
    ...
    return function e2(t2, n2, r22) {
      ...
      for (var i2 = typeof __require == "function" && __require, o2 = 0; o2 < r22.length; o2++)
        s2(r22[o2]);
      return s2;
      ...
      function moveToMostRecentLru(lru, lruPath) {
        ...
        for (i2 = 0; i2 < lruLen; i2++) {
          for (isMatch = true, ii2 = 0; ii2 < lruPathLen; ii2++)
            if (!isEqual(lru[i2][ii2].arg, lruPath[ii2].arg)) {
              isMatch = false;
              break;
            }
          if (isMatch)
...
function _extends() {
  return _extends = Object.assign ? Object.assign.bind() : function(n2) {
    for (var e2 = 1; e2 < arguments.length; e2++) {
      var t2 = arguments[e2];
      for (var r22 in t2)
        ({}).hasOwnProperty.call(t2, r22) && (n2[r22] = t2[r22]);
    }
    return n2;
...
var Preview = ({ isLoading, isColumn, columns, children, withSource, withToolbar = false, isExpanded = false, additionalActions, className, layout = "padded", inline = false, ...props }) => {
  let [expanded, setExpanded] = (0, import_react.useState)(isExpanded), { source, actionItem } = getSource(withSource, expanded, setExpanded), [scale, setScale] = (0, import_react.useState)(1), previewClasses = [className].concat(["sbdocs", "sbdocs-preview", "sb-unstyled"]), defaultActionItems = withSource ? [actionItem] : [], [additionalActionItems, setAdditionalActionItems] = (0, import_react.useState)(additionalActions ? [...additionalActions] : []), actionItems = [...defaultActionItems, ...additionalActionItems], { window: globalWindow4 } = globalThis, copyToClipboard = (0, import_react.useCallback)(async (text) => {
    let { createCopyToClipboardFunction } = await import("./components-AWWLWBX6.js");
...
function t() {
  return t = Object.assign ? Object.assign.bind() : function(e2) {
    for (var t2 = 1; t2 < arguments.length; t2++) {
      var n2 = arguments[t2];
      for (var r22 in n2)
        Object.prototype.hasOwnProperty.call(n2, r22) && (e2[r22] = n2[r22]);
    }
    return e2;
...
function Ve2(e2, t2, n2) {
  ...
  for (; i2.length && (r22 = r22[i2[0]], r22 !== void 0); )
    i2.shift();
  return r22 || n2;
}
function Xe(n2 = "", i2 = {}) {
...
var index_modern_default = (t2) => {
  let { children: r22 = "", options: i2 } = t2, l2 = function(e2, t3) {
    ...
    for (r3 = 0; r3 < l32.length; r3++)
      t3.indexOf(n2 = l32[r3]) >= 0 || (i3[n2] = e2[n2]);
    return i3;
  }(t2, n);
...
var LazyColorControl = (0, import_react.lazy)(() => import("./Color-AVL7NMMY-M6EPIWZK.js"));
...
var CodeOrSourceMdx = ({ className, children, ...rest }) => {
  if (typeof className != "string" && (typeof children != "string" || !children.match(/[\n\r]/g)))
    return import_react.default.createElement(ii, null, children);
...
var Heading2 = ({ children, disableAnchor, ...props }) => {
  if (disableAnchor || typeof children != "string")
    return import_react.default.createElement(ui, null, children);
...
var Subheading = ({ children, disableAnchor }) => {
  if (disableAnchor || typeof children != "string")
    return import_react.default.createElement(fi, null, children);
  let tagID = slugs.slug(children.toLowerCase());
...
//# sourceMappingURL=chunk-DMISP5KZ.js.map
