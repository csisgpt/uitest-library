<template>
  <thead class="base-table__header">
    <tr>
      ...
      <th
        v-if="selectable"
        class="base-table__header-cell base-table__header-cell--checkbox"
      >
        <input
          type="checkbox"
          :checked="selectedAll"
        ...
        <div class="header-cell-content">
          ...
          <span v-if="column.sortable" class="sort-icon">
            ...
            <IconChevronDown
              ...
              :size="14"
            />
            <IconSelector v-else :size="14" class="sort-icon--inactive" />
          </span>
      ...
      <th
        v-if="hasActions"
        class="base-table__header-cell base-table__header-cell--actions"
      >
        عملیات
      </th>
    </tr>
